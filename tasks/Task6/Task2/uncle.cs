...
namespace Task2
{
    public class uncle : IFamMember  // Sub-Class uncle for SUPER-Class FamMember
    {
        ...
        public string Member_status =>  " " + "Uncle".PadRight(10) + "|".PadRight(5) + First_Name.PadRight(10) + "|".PadRight(5) + Sex.PadRight(10) + "|".PadRight(5) + Age;
