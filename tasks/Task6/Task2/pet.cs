...
namespace Task2
{
    public class pet : IFamMember  // Sub-Class uncle for SUPER-Class FamMember
    {
       
        public pet(string first_name, string sex, int age) //Constructor
        {
        ...
        public string Member_status =>  " " + "Pet".PadRight(10) + "|".PadRight(5) + First_Name.PadRight(10) + "|".PadRight(5) + Sex.PadRight(10) + "|".PadRight(5) + Age;
