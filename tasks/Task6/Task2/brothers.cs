...
namespace Task2
{
    public class brothers : IFamMember  // Sub-Class brothers for SUPER-Class FamMember
    {
        ...
        public string Member_status => " " + "Brother".PadRight(10) + "|".PadRight(5) + First_Name.PadRight(10) + "|".PadRight(5) + Sex.PadRight(10) + "|".PadRight(5) + Age;
